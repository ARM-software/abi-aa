...
+=============+===============================+==========+===================================================+
| 1.0         |                               | LS       | First public release.                             |
+-------------+-------------------------------+----------+---------------------------------------------------+
| 2.0         | 24\ :sup:`th` March 2005      | LS       | Second public release.                            |
+-------------+-------------------------------+----------+---------------------------------------------------+
| 2.01        | 22\ :sup:`nd` August 2005     | LS       | Minor typographical corrections in                |
|             |                               |          | `Exception-handling table entries`_.              |
+-------------+-------------------------------+----------+---------------------------------------------------+
| 2.02        | 5\ :sup:`th` October 2005     | AC       | Add \_\_cxa\_get\_exception\_ptr,                 |
|             |                               |          | \_Unwind\_DeleteException, and VFP v3 support.    |
|             |                               |          | Minor edits for clarity.                          |
+-------------+-------------------------------+----------+---------------------------------------------------+
| 2.03        | 31\ :sup:`st` October 2006    | AC       | Minor edits for clarity, particularly regarding   |
|             |                               |          | use of the exception\_cleanup field. Change to    |
|             |                               |          | \_Unwind\_State type.                             |
+-------------+-------------------------------+----------+---------------------------------------------------+
| 2.04        | 25\ :sup:`th` January 2007    | LS       | Tiny clarification at end of paragraph 5 in       |
|             |                               |          | `Phase 2 unwinding`_.                             |
+-------------+-------------------------------+----------+---------------------------------------------------+
| A           | 25\ :sup:`th` October 2007    | LS       | Document renumbered (formerly GENC-003536 v2.04). |
+-------------+-------------------------------+----------+---------------------------------------------------+
| B           | 24\ :sup:`th` November 2015   | CR       | Use UAL instruction mnemonics where possible.     |
+-------------+-------------------------------+----------+---------------------------------------------------+
| 2018Q4      | 21\ :sup:`st` December 2018   | OS       | Minor typographical fixes, updated links.         |
+-------------+-------------------------------+----------+---------------------------------------------------+
...
5. \_URC\_INSTALL\_CONTEXT instructs the unwinder to save any state it
   ...
   If Branch Target Identification mechanism is enabled, the unwinder
   may elect to transfer control to the routine installed in VRS[r15]
   via a jump instruction that requires the jump target to be
   identified as a valid destination for indirect jumps.

   .. note::

    The intent is that the the routine installed in VRS[r15] should start with a
    ``bti`` instruction (or equivalent), when it might operate in an environment
    with Branch Target Identification enabled.
